...
func (c *Char) stateChange1(no int32, pn int) bool {
	...
	// Reset persistent counters for this state
	...
	// There's still an issue with helpers but this is the closest we've gotten
	// https://github.com/ikemen-engine/Ikemen-GO/issues/1434
	if !c.stchtmp {
