...
local motif =
{
	...
	title_info =
	{
		...
		menu_pos = {159, 158},
		menu_item_font = {'f-6x9.def', 0, 0, 191, 191, 191},
		...
		menu_item_active_font = {'f-6x9.def', 0, 0, 255, 255, 255},
	...
	select_info =
	{
		...
		cancel_snd = {100, 2},
		portrait_anim = nil, --Ikemen feature
		portrait_spr = {9000, 0},
		portrait_offset = {0, 0},
		portrait_scale = {1.0, 1.0},
		title_offset = {0, 0},
		title_font = {'jg.fnt', 0, 0, 255, 255, 255},
		...
		stage_portrait_bg_anim = nil, --Ikemen feature
		...
		p1_teammenu_selftitle_font = {'jg.fnt', 0, 1, 255, 255, 255},
		...
		p1_teammenu_enemytitle_font = {'jg.fnt', 0, 1, 255, 255, 255},
		...
		p1_teammenu_item_font = {'jg.fnt', 0, 1, 255, 255, 255},
		p1_teammenu_item_font_scale = {1.0, 1.0},
		p1_teammenu_item_font_height = -1, --Ikemen feature
		p1_teammenu_item_active_font = {'jg.fnt', 3, 1, 255, 255, 255},
		...
		p1_teammenu_item_active2_font = {'jg.fnt', 0, 1, 255, 255, 255},
		...
		p2_teammenu_selftitle_font = {'jg.fnt', 0, -1, 255, 255, 255},
		...
		p2_teammenu_enemytitle_font = {'jg.fnt', 0, -1, 255, 255, 255},
		...
		p2_teammenu_item_font = {'jg.fnt', 0, -1, 255, 255, 255},
		p2_teammenu_item_font_scale = {1.0, 1.0},
		p2_teammenu_item_font_height = -1, --Ikemen feature
		p2_teammenu_item_active_font = {'jg.fnt', 1, -1, 255, 255, 255},
		...
		p2_teammenu_item_active2_font = {'jg.fnt', 0, -1, 255, 255, 255},
		...
		record_font = {'jg.fnt', 0, 0, 255, 255, 255}, --Ikemen feature
	...
	vs_screen =
	{
		...
		match_text = 'Match %i',
		match_offset = {159, 12},
		match_font = {'jg.fnt', 0, 0, 255, 255, 255},
		...
		p1_name_pos = {0, 0},
		p1_name_offset = {0, 0},
		p1_name_font = {'jg.fnt', 0, 0, 255, 255, 255},
		p1_name_font_scale = {1.0, 1.0},
		p1_name_font_height = -1, --Ikemen feature
		p1_name_spacing = {0, 14},
		p2_name_pos = {0, 0},
		p2_name_offset = {0, 0},
		p2_name_font = {'jg.fnt', 0, 0, 255, 255, 255},
		p2_name_font_scale = {1.0, 1.0},
		p2_name_font_height = -1, --Ikemen feature
		p2_name_spacing = {0, 14},
	...
	continue_screen =
	{
		...
		counter_anim = nil, --Ikemen feature
	...
	victory_screen =
	{
		...
		winquote_font = {'f-6x9.def', 0, 1, 255, 255, 255},
	...
	rank_info =
	{
		...
		--p<pn>_gauge_<type>_anim = nil, --Ikemen feature
		...
		--p<pn>_rank_<num>_anim = nil, --Ikemen feature
	...
	hiscore_info =
	{
		...
		face_unknown_anim = nil, --Ikemen feature
	...
	tournament_info =
	{
		...
		--p<1-16>_bg_anim = nil, --Ikemen feature
		...
		--p<1-16>_face_anim = nil, --Ikemen feature
		...
		--p<1-16>_ko_anim = nil, --Ikemen feature
		...
		--round1_match<1-16>_team<1-2>_anim = nil, --Ikemen feature
		...
		--round2_match<1-8>_team<1-2>_anim = nil, --Ikemen feature
		...
		--round3_match<1-4>_team<1-2>_anim = nil, --Ikemen feature
		...
		--round4_match1_team<1-2>_anim = nil, --Ikemen feature
		...
		--trophy_anim = nil, --Ikemen feature
...
function motif.f_loadSprData(t, v)
	...
	if t[v.s .. 'anim'] ~= nil and motif.anim[t[v.s .. 'anim']] ~= nil then --create animation data
...
for _, v in ipairs({'title_info', 'select_info', 'vs_screen', 'demo_mode', 'continue_screen', 'victory_screen', 'win_screen', 'survival_results_screen', 'vs100_kumite_results_screen', 'time_attack_results_screen', 'time_challenge_results_screen', 'score_challenge_results_screen', 'boss_rush_results_screen', 'option_info', 'replay_info', 'menu_info', 'training_info', 'attract_mode', 'challenger_info', 'hiscore_info', 'tournament_info'}) do
	if motif[v].fadein_anim ~= nil then
		motif.f_loadSprData(motif[v], {s = 'fadein_', x = 0, y = 0})
	end
	if motif[v].fadeout_anim ~= nil then
