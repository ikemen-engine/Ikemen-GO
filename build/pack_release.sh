...
7z a -tzip ./release/Ikemen_GO_Win_x86.zip ../script ../data ../font 'Ikemen_GO_Win_x86.exe' 'soft_oal_x86.dll'
...
7z a -tzip ./release/Ikemen_GO_Win_x64.zip ../script ../data ../font 'Ikemen_GO_Win_x64.exe' 'soft_oal_x64.dll'
...
7z a -tzip ./release/Ikemen_GO_Mac.zip ../script ../data ../font Ikemen_GO.command Ikemen_GO_mac
7z a -tzip ./release/Ikemen_GO_Linux.zip ../script ../data ../font Ikemen_GO.command Ikemen_GO_linux